...
Codex, and OpenCode/generic Agent Skills consumers. Keep optional Skillshare
Hub metadata working for users who already use Skillshare.
...
- `skillshare-hub.json` as optional generated discovery metadata for
  Skillshare Hub users
